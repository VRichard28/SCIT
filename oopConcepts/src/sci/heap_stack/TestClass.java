...
public class TestClass {
    ...
    public static void main(String args[]) {
        ...
        int i = 5;
        updatePrimiteDataType(i);// tipurile de date primitive se paseaza prin valoare
        System.out.println(i);

        //obiect = in metode se paseaya adresa de memorie a obiectului
    ...
    private static void updatePrimiteDataType(int primiteveDataType) {
        primiteveDataType = 7;
    }
